  ...
  return (
    <div className="max-w-md mx-auto glass p-8 rounded-2xl animate-fade-in mt-12 border border-white/45">
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Join FoodieExpress today</p>
      </div>
      ...
      <div className="mt-6 text-center text-sm text-slate-600">
        ...
        <Link to="/login" className="text-orange-500 hover:text-orange-600 font-semibold underline">
          Login
        </Link>
      </div>
    </div>
